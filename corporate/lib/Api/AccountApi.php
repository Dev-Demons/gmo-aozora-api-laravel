...
class AccountApi
{
     ...
     * @return \Ganb\Corporate\Client\Model\DepositTransactionsResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\DepositTransactionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\DepositTransactionsResponse',
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\AccountsResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\AccountsResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\AccountsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $x_access_token アクセストークン  minLength: 1 maxLength: 128 (required)
     * @param  string $account_id 口座ID 口座を識別するID  minLength: 12 maxLength: 29 (optional)
     *
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\BalancesResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\BalancesResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\BalancesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\TransactionsResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\TransactionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\TransactionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ganb\Corporate\Client\Model\VisaTransactionsResponse
     */
     ...
     * @throws \Ganb\Corporate\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ganb\Corporate\Client\Model\VisaTransactionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ganb\Corporate\Client\Model\VisaTransactionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
